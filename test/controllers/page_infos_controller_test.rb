...
class PageInfosControllerTest < ActionController::TestCase
  ...
  test "should create page_info" do
    assert_difference('PageInfo.count') do
      post :create, page_info: { category: @page_info.category, description: @page_info.description, title: @page_info.title }
    end
  ...
  test "should update page_info" do
    patch :update, id: @page_info, page_info: { category: @page_info.category, description: @page_info.description, title: @page_info.title }
    assert_redirected_to page_info_path(assigns(:page_info))
  end
